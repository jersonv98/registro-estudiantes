...
namespace registroEstudiantes.Controllers
{
    public class AspNetUserRolesController : Controller
    {
        ...
        public AspNetUserRolesController(registroEstudiantesContext context)
        {
            _context = context;
        }
        ...
        {
            var registroEstudiantesContext = _context.AspNetUserRoles.Include(a => a.Role).Include(a => a.User);
